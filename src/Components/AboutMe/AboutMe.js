        ...
        return (
            <div className="AboutMe">
                ...
                <div className="aboutBio">
                    ...
                    <p className="center"><a href="https://github.com/KGood93" className="pageLink">Github</a></p>  
                    <p className="center"><a href="https://www.linkedin.com/in/kathryn-goodreau-6a18b4114" className="pageLink">LinkedIn</a></p>
